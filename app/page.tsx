          ...
          >
            <div className="grid grid-cols-[1fr_48px_1fr] items-center gap-2 sm:grid-cols-[1fr_120px_1fr]">
              <div className="text-center">
                ...
                <div className="mt-5">
                  <p className="text-[6px] font-black uppercase tracking-[0.16em] text-white/30 sm:text-[7px]">
                    Últimos 4
                  </p>

                  <div className="mt-2 flex justify-center gap-1.5 sm:gap-2">
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-red-400/10 text-[7px] font-black text-red-300 sm:h-8 sm:w-8">D</span>
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-400/10 text-[7px] font-black text-emerald-300 sm:h-8 sm:w-8">V</span>
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-red-400/10 text-[7px] font-black text-red-300 sm:h-8 sm:w-8">D</span>
                    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-cyan-300/10 text-[7px] font-black text-cyan-300 sm:h-8 sm:w-8">E</span>
                  </div>
                </div>
              </div>
